      ...
      <div class="drawer-side z-40">
        ...
        <aside class="bg-base-200 min-h-full w-64 border-r border-base-300 flex flex-col">
          ...
          <ul class="menu menu-md p-3 gap-1 flex-1">
            ...
            <li class="menu-title text-xs uppercase tracking-wider opacity-60 mt-4">Director</li>
            <li>
              <a href="/director/domains" class={nav_active(@current_path, "/director/domains")}>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
            ...
            <li>
              <a href="/director/settings" class={nav_active(@current_path, "/director/settings")}>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
